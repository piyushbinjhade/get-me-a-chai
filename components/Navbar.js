      ...
      <div className='relative flex items-center'>
        ...
        {session && (
          <div className="relative">
            ...
            <div 
              id="dropdown" 
              className={`z-10 ${showdropdown ? "" : "hidden"} absolute right-0 mt-2 bg-white divide-y divide-gray-100 rounded-lg shadow-lg w-44 dark:bg-gray-700`}
            >
        ...
        {session === undefined ? null : !session && (
          <Link href="/login">
            <button className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-all duration-300">
              Login
            </button>
          </Link>
        )}
